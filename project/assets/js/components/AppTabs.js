...
import LowDoseExtrapolationsEdit from '../containers/LowDoseExtrapolationsEdit';
import LowDoseExtrapolations from '../containers/LowDoseExtrapolations';
...
class AppTabs extends React.Component {
    ...
    renderReadContent(){
        return (
            <div className='tab-content' style={{paddingTop: '1em'}}>
                ...
                <div role='tabpanel' className='tab-pane' id='lowDoseExtrapolations'>
                    <LowDoseExtrapolations  />
    ...
    renderEditTabs(){
        ...
        let lowDoseExtrapolationTabClass = (this.props.bmds.objects && this.props.bmds.objects.length != 0) ? '' : 'disabled',
            lowDoseExtrapolationDataToggle = (this.props.bmds.objects && this.props.bmds.objects.length != 0) ? 'tab' : 'dropdown';
        return (
            <ul className='nav nav-tabs' role='tablist'>
                ...
                <li className={lowDoseExtrapolationTabClass}>
                    <a href='#lowDoseExtrapolations'
                        data-toggle={lowDoseExtrapolationDataToggle}>Low dose extrapolations</a>
                </li>
    ...
    renderReadTabs(){
        return (
            <ul className='nav nav-tabs' role='tablist'>
                ...
                <li>
                    <a href='#lowDoseExtrapolations'
                        data-toggle='tab'>Low dose extrapolations</a>
                </li>
            </ul>
        );
    }
